...
salary_bins <- read.csv(here("supplementary_tables/ee_dv_salarybins.csv"))
...
quintile_ranges <- read.csv(here("supplementary_tables/quintile_ranges.csv"), encoding = "UTF-8-BOM")
...
## Plot 1: DI of all groups by salary range (`r recent_year`)
...
## Plot 2: A direct comparison of DI in Black Employees vs. Non-Visible Minority Employees (`r recent_year`)
...
## Plot 4: A direct comparison of DI in Black Employees vs. Non-Visible Minority Employees Over All Years (2017-`r recent_year`)
...
## Plot 5: Disparity between Non-visible Minority Employees and Black Employees Over Time (2017- `r recent_year`)
...
::: {.content-visible when-profile="french"}
## Graphique 1: ID de tous les groupes par tranche de salaire (`r recent_year`)
...
## Graphique 2: Comparaison directe de l'AI chez les employés du race noirs et chez les employés n'appartenant pas à une minorité visible (`r recent_year`)
...
## Graphique 4: Comparaison directe des DI des employés noirs par rapport aux employés n'appartenant pas à une minorité visible sur toutes les années (2017-`r recent_year`)
...
## Graphique 5 : Disparité entre les employés issus des minorités non visibles et les employés noirs au fil du temps (2017-`r recent_year`)
