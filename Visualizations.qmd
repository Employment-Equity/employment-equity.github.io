...
# write.csv(years_data_cat, file = "years_data_cat.csv")
...
rm(imputation_data, imputation_data_black, imputation_data_indigenous, imputation_data_vm, temp, years_data_cat, years_data_clean, end.time, start.time, time.taken)
...
# If bigger than all employees, make organge. If less, make blue
